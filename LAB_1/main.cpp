...
{ // The beginning of the body of the program
	...
	A1 = (((A + 3 * C) / (2 * A * C)) + 5.3 * pow(10, -3) * pow(A, (2 / 5))); // Calculation of the transit a1
	A2 = (exp(cos(A)) - 0.9 * pow(10, 0.8)); // Calculation of the variable A2
	Y = A1 / A2; // Calculation of the variable y
